...
async function performSearch(searchQuery) {
    try {
        ...
        if (hits.length > 0) {
            ...
            scrollPage();
        } else (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
    } catch (error) {
...
},{"simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","notiflix":"fuMq1","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9ydBq":[function(require,module,exports) {
/*!
